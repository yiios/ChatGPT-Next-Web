...
const vi: PartialLocaleType = {
 ...
 `,
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Sử dụng API Key với một cú nhấp chuột",
        Label: "(Giải pháp tiết kiệm chi phí nhất/ổn định trong 2 năm)",
        SubTitle:
          "Dịch vụ AI được 小鱼 chính thức duy trì, sẵn sàng sử dụng ngay khi mua, hỗ trợ các mô hình lớn mới nhất như OpenAI GPT-4o",
        ChatNow: "Mua ngay",
      },
