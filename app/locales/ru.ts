...
const ru: PartialLocaleType = {
 ...
 `,
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Используйте ключ API одним кликом",
        Label: "(Самое экономичное решение/стабильность на 2 года)",
        SubTitle:
          "Официально поддерживаемый 小鱼, готовый к использованию сразу после покупки, поддерживает последние крупные модели, такие как OpenAI GPT-4o",
        ChatNow: "Купить сейчас",
      },
