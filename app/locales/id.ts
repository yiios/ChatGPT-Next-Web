...
`,
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Beli Kunci API Sekali Klik",
        Label: "(Pilihan Paling Hemat Biaya/Stabil Selama 2 Tahun)",
        SubTitle:
          "Layanan AI yang dikelola secara resmi oleh 小鱼, siap digunakan setelah pembelian, mendukung model besar terbaru seperti OpenAI GPT-4o",
        ChatNow: "Beli Sekarang",
      },
