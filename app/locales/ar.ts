...
const ar: PartialLocaleType = {
 ...
 `,
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "شراء مفتاح API بنقرة واحدة",
        Label: "(أفضل قيمة/استقرار لمدة عامين)",
        SubTitle:
          "خدمة AI مدعومة رسميًا من قبل 小鱼، جاهزة للاستخدام عند الشراء، تدعم أحدث النماذج الكبيرة مثل OpenAI GPT-4o",
        ChatNow: "اشترِ الآن",
      },
      AccessCode: {
