...
const sk: PartialLocaleType = {
 ...
 `,
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Použite kľúč API jedným kliknutím",
        Label: "(Najvýhodnejšie riešenie/stabilita na 2 roky)",
        SubTitle:
          "Oficiálne spravovaná služba AI od 小鱼, pripravená na použitie po zakúpení, podporuje najnovšie veľké modely ako OpenAI GPT-4o",
        ChatNow: "Kúpte teraz",
      },
      AccessCode: {
