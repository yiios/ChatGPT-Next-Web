...
`,
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Usar clave API con un clic",
        Label: "(La solución más económica/estabilidad de 2 años)",
        SubTitle:
          "Servicio de IA mantenido oficialmente por 小鱼, listo para usar al momento de la compra, soporta los últimos grandes modelos como OpenAI GPT-4o",
        ChatNow: "Compra ahora",
      },
      AccessCode: {
