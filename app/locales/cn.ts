...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ? `😆 对话遇到了一些问题，不用慌:
       \\ 1️⃣ 请前往[设置](/#/settings)页检查 API 密钥 是否配置正确 ⚙️`
      : `😆 开始聊天前，请前往[设置](/#/settings)页填入你自己的 OpenAI API 密钥:
       \ 1️⃣ 不知道如何获取 OpenAI API 密钥？🔑
       \ 2️⃣ 您可以在这里购买：[https://s.yiios.com/](https://s.yiios.com/) 
       \ 
       \ **不知道如何使用小鱼客服助手？**
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        ...
        Label: "（最高性价比/稳定两年）",
        SubTitle:
          "由小鱼官方维护的 AI 服务，购买即用，支持 OpenAI GPT-4o 等最新大模型",
        ChatNow: "立刻购买",
      },
      AccessCode: {
        Title: "访问密码",
