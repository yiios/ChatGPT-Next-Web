...
const it: PartialLocaleType = {
 ...
 `,
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Acquista una chiave API con un clic",
        Label: "(La soluzione più conveniente/stabilità di 2 anni)",
        SubTitle:
          "Servizio AI ufficialmente mantenuto da 小鱼, pronto all'uso al momento dell'acquisto, supporta i modelli più recenti come OpenAI GPT-4o",
        ChatNow: "Acquista ora",
      },
      AccessCode: {
