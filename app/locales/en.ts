...
const en: LocaleType = {
  ...
  Error: {
    Unauthorized: isApp
     ...
     \\ 1️⃣ Invalid API Key, please check it in [Settings](/#/settings) page.\nplease visit: [https://s.yiios.com](https://s.yiios.com) to repurchase.`
      : `😆 Oops, there's an issue. Let's fix it:
     \ 1️⃣ Unauthorized access, please enter your OpenAI API Key.\nplease visit: [https://s.yiios.com](https://s.yiios.com) to repurchase. 🔑
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Purchase API Key with One Click",
        Label: "(Most Cost-Effective/Stable for 2 Years)",
        SubTitle:
          "AI service maintained by 小鱼, ready to use upon purchase, supports the latest large models like OpenAI GPT-4o",
        ChatNow: "Buy Now",
      },
      AccessCode: {
        Title: "Access Code",
