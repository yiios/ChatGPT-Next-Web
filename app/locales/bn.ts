...
const bn: PartialLocaleType = {
 ...
 `,
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "এক ক্লিকে API কী কিনুন",
        Label: "(সর্বোচ্চ মূল্যসাশ্রয়/দুই বছরের স্থিতিশীলতা)",
        SubTitle:
          "ছোট মাছ দ্বারা অফিসিয়াল রক্ষণাবেক্ষণ করা AI পরিষেবা, কেনার সাথে সাথে ব্যবহারের জন্য প্রস্তুত, OpenAI GPT-4o সহ সর্বশেষ বড় মডেলগুলি সমর্থন করে",
        ChatNow: "এখনই কিনুন",
      },
      AccessCode: {
