...
const tr: PartialLocaleType = {
 ...
 `,
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "API anahtarını bir tıklama ile satın alın",
        Label: "(En maliyet etkin çözüm/2 yıl stabilite)",
        SubTitle:
          "xiaoyu tarafından resmi olarak yönetilen AI hizmeti, satın alma ile birlikte kullanılabilir, OpenAI GPT-4o gibi en son büyük modelleri destekler",
        ChatNow: "Şimdi satın al",
      },
