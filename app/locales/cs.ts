...
const cs: PartialLocaleType = {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Kupte API klíč jedním kliknutím",
        Label: "(Nejlepší cena/2 roky stability)",
        SubTitle:
          "AI služba oficiálně spravována 小鱼, připravena k použití ihned po zakoupení, podporuje nejnovější velké modely jako OpenAI GPT-4o",
        ChatNow: "Kupte nyní",
      },
      AccessCode: {
