...
const de: PartialLocaleType = {
 ...
 `,
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "API-Schlüssel mit einem Klick kaufen",
        Label: "(Die beste Kosten-Nutzen-Relation/2 Jahre Stabilität)",
        SubTitle:
          "Von 小鱼 offiziell verwalteter AI-Service, sofort nach dem Kauf einsatzbereit, unterstützt die neuesten großen Modelle wie OpenAI GPT-4o",
        ChatNow: "Jetzt kaufen",
      },
      AccessCode: {
        Title: "Zugangscode",
        SubTitle:
