...
const fr: PartialLocaleType = {
 ...
 `,
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Acheter une clé API en un clic",
        Label: "(Meilleur rapport qualité/prix/stabilité de 2 ans)",
        SubTitle:
          "Service AI officiellement maintenu par 小鱼, prêt à l'emploi dès l'achat, prend en charge les derniers grands modèles comme OpenAI GPT-4o",
        ChatNow: "Achetez maintenant",
      },
