...
const no: PartialLocaleType = {
 ...
 `,
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Kjøp API-nøkkel med ett klikk",
        Label: "(Den mest kostnadseffektive løsningen/stabil i 2 år)",
        SubTitle:
          "AI-tjeneste offisielt vedlikeholdt av 小鱼, klar til bruk ved kjøp, støtter de nyeste store modellene som OpenAI GPT-4o",
        ChatNow: "Kjøp nå",
      },
